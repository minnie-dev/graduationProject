...
/**
 * Created by jome9 on 2019-09-09.
 */

public class Keepbicycle_menu extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_keepbicycle_menu);

        TextView logininformationText = (TextView) findViewById(R.id.logininformation);
        LinearLayout findnameBtn = (LinearLayout) findViewById(R.id.findname);
        LinearLayout findnearBtn = (LinearLayout) findViewById(R.id.findnear);
        ...
        findnameBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), Keepbicycle.class);
                startActivity(intent);
            }
        });
        findnearBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), neartest.class);
                startActivity(intent);
            }
        });
